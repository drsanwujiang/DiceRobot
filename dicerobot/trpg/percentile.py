...
十位与个位都是 0 时结果为 100，因此必须先组合成结果再比较：个位为 0、十位掷出 0 与 9 时
候选是 100 与 90，奖励骰取 90；若改比十位数字则会取到 0，反而得出 100。
...
class PercentileRoll:
    ...
    def __str__(self) -> str:
        ...
        方括号内是追加的十位骰原值。不写成 10：10 会被读作结果 100，而十位 0 只在个位
        也是 0 时才记 100，否则是 01 到 09。
        """
