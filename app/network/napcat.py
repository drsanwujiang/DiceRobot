...
def get_login_info() -> GetLoginInfoResponse:
    return GetLoginInfoResponse.model_validate(client.get(
...
def get_group_info(group_id: int, no_cache: bool = False) -> GetGroupInfoResponse:
    return GetGroupInfoResponse.model_validate(client.get(
...
def get_group_member_info(group_id: int, user_id: int, no_cache: bool = False) -> GetGroupMemberInfoResponse:
...
def get_group_member_list(group_id: int) -> GetGroupMemberListResponse:
...
def send_private_message(
    ...
    return SendPrivateMessageResponse.model_validate(client.post(
...
def set_group_card(
    ...
    return SetGroupCardResponse.model_validate(client.post(
...
def set_group_leave(
    ...
    return SetGroupLeaveResponse.model_validate(client.post(
...
def set_friend_add_request(
    ...
    return SetFriendAddRequestResponse.model_validate(client.post(
...
def set_group_add_request(
    ...
    return SetGroupAddRequestResponse.model_validate(client.post(
